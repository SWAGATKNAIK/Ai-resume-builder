...
const Features = () => {
  ...
  return (
     <div id= 'features' className='flex flex-col items-center my-10 scroll-mt-12'>
        ...
        <div className="flex items-center gap-2 text-sm text-green-800 bg-green-600/10 rounded-full px-6 py-1.5">
            <Zap width={15} />
            <span>Simple Process</span>
        </div>
        <Title title='Build your resume in minutes' description='Create a professional resume in just a few clicks with our easy-to-use builder.' />
